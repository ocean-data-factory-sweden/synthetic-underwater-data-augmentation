...
```bash /opt/local/bin/run_py_job.sh -e stylegan -p gpu-shannon -c 8 generate.py --output=out_dir --num-rows=10 --num-cols=12 --network=/models/network-snapshot-000280.pkl```
